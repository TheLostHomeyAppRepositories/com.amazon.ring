        ...
        let request = https.request(url, (response) => {
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400 ) {
                    ...
                    let logLine = " Api.js || " + "_https_token || " + response.statusCode + " " + data;
        ...
        let request = https.request(url, (response) => {
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400) {
                    ...
                    let logLine = " Api.js || " + "_https_auth_mfa_refresh || " + response.statusCode + " " + data;
                    this.homey.app.writeLog(logLine);
                    this._setAuthenticationStatus(false, result);
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400) {
                    if(response.statusCode==412)
                    {
                        ...
                        let logLine = " Api.js || " + "_https_auth_cred || " + response.statusCode + " " + data;
                        this.homey.app.writeLog(logLine);
                        this._setAuthenticationStatus(false, result);
        ...
        let request = https.request(url, (response) => {
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400) {
                    ...
                    let logLine = " Api.js || " + "_https_auth_code || " + response.statusCode + " " + data;
                    this.homey.app.writeLog(logLine);
                    this._setAuthenticationStatus(false, result);
                    ...
                    try {
                        ...
                        let logLine = " Api.js || " + "_https_auth_code || " + "Succesfully authenticated.";
                        this.homey.app.writeLog(logLine);
                        this._setAuthenticationStatus(true, null);
                    } catch (e) {
                        error = e;
        ...
        let request = https.request({
            ...
            response.on('end', () => {
                ...
                if (response.statusCode == 404) { //Not found
                    ...
                    let logLine = " Api.js || " + "_https || " + response.statusCode + " " + data;
                    this.homey.app.writeLog(logLine);
                    this._setAuthenticationStatus(false, result);
