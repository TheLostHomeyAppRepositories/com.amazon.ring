    ...
    async _connectRingAPI() {
        ...
        try {
            ...
            this.locations.forEach(async location => {
                this.log('Ring Alarm               ',location.hasAlarmBaseStation);
                ...
                location.onMessage.subscribe((message) => {
                    this,log('onMessage',message)
                    this.log('---------------------------------------')
                });

                location.onDataUpdate.subscribe((dataUpdate) => {
                    this,log('onDataUpdate',dataUpdate)
                    this.log('=======================================')
                });

                location.onDeviceDataUpdate.subscribe((deviceDataUpdate) => {
                    this,log('onDeviceDataUpdate',deviceDataUpdate)
                    this.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
                });
