...
class Api extends Homey.SimpleClass {
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400 ) {
                    ...
                    try {
                        ...
                        console.log("json parse succesful on 131")
                    } catch (e) {
                        console.log("json parse error on 131")
                    ...
                    try {
                        result = JSON.parse(data);
                        //console.log("json parse succesful on 140")
                        this._setAuthenticationStatus(true, null);
                    } catch (e) {
                        console.log("json parse error on 140")
                        error = e;
                    }
                }
        ...
        let request = https.request(url, (response) => {
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400) {
                    ...
                    try {
                        result = JSON.parse(data);
                        //console.log("json parse succesful on 230")
                    } catch (e) {
                        console.log("json parse error on 230")
                        result = JSON.parse('{"error": "invalid_response ' + response.statusCode + '", "error_description": "' + data + '"}');
                    }
                    this._setAuthenticationStatus(false, result);
                    ...
                    try {
                        result = JSON.parse(data);
                        // console.log("json parse succesful on 240")
                        this._setAuthenticationStatus(true, null);

                    } catch (e) {
                        console.log("json parse error on 240")
                        error = e;
                    }
                }
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400) {
                    if(response.statusCode==412)
                    {
                        ...
                        try {
                            result = JSON.parse(data);
                            //console.log("json parse succesful on 311")

                        } catch (e) {
                            console.log("json parse error on 311")
                            result = JSON.parse('{"error": "invalid_response ' + response.statusCode + '", "error_description": "' + data + '"}');
                        }
                        this._setAuthenticationStatus(false, result);
                        ...
                        try {
                            result = JSON.parse(data);
                            console.log("json parse succesful on 325")
                        } catch (e) {
                            console.log("json parse error on 325")
                            result = JSON.parse('{"error": "invalid_response ' + response.statusCode + '", "error_description": "' + data + '"}');
                        }         
                        this._setAuthenticationStatus(false, result);
                    ...
                    try {
                        result = JSON.parse(data);
                        console.log("json parse succesful on 336")
                        this._setAuthenticationStatus(true, null);

                    } catch (e) {
                        console.log("json parse error on 336")
                        error = e;
                    }
                }
        ...
        let request = https.request(url, (response) => {
            ...
            response.on('end', () => {
                ...
                if (response.statusCode >= 400) {
                    ...
                    try {
                        result = JSON.parse(data);
                        console.log("json parse successful on 409")
                    } catch (e) {
                        console.log("json parse error on 409")
                        result = JSON.parse('{"error": "invalid_response ' + response.statusCode + '", "error_description": "' + data + '"}');
                    }
                    this._setAuthenticationStatus(false, result);
                    ...
                    try {
                        result = JSON.parse(data);
                        console.log("json parse successful on 419")
                        ...
                        console.log("json parse error on 419")
                        error = e;
                    }
                }
        ...
        let request = https.request({
            ...
            response.on('end', () => {
                ...
                if (response.statusCode == 404) { //Not found
                    ...
                    try {
                        result = JSON.parse(data);
                        console.log("json parse successful on 528")
                    } catch (e) {
                        console.log("json parse error on 528")
                        result = JSON.parse('{"error": "invalid_response ' + response.statusCode + '", "error_description": "' + data + '"}');
                    }
                    this._setAuthenticationStatus(false, result);
                ...
                let logLine = " Api.js || " + "_https || " + " We are no longer authenticated Who's faster? ";
                this.homey.app.writeLog(logLine);
                        ...
                        this._verifyAuthentication((error, result) => {
                            if (!error)
                            {
                                ...
                                this._authenticating = false;
                                this.log('_verifyAuthentication:  ', error);
                            }
                        });
                    }
                    ...
                    try {
                        result = JSON.parse(data);
                        console.log("json parse successful on 560")
                    } catch (e) {
                        try {
                            console.log("json parse error on 560")
                            result = JSON.parse('{"error": "invalid_response ' + response.statusCode + '", "error_description": "' + data + '"}');
                            console.log("json parse successful on 565")
                        } catch(e) {
                            console.log("json parse error on 565")
    ...
    _setAuthenticationStatus (status, result) {
        ...
        if (this._previousAuthenticated != this._authenticated) {
            ...
            let logLine = " Api.js || " + "_setAuthenticationStatus || " + " We are no longer authenticated Who's faster? ";
            this.homey.app.writeLog(logLine);                
                 logLine = " Api.js || " + "_setAuthenticationStatus || " + " Not Authenticated ";
                this.homey.app.writeLog(logLine);
                this.homey.api.realtime('com.ring.status', { state: 'unauthenticated'});
            }
        ...
        this._https_auth_mfa_refresh((error, result) => {
            ...
            this._https_token(result.access_token, (error, result) => {
                ...
                if (typeof(result) == 'object' && result.hasOwnProperty('profile') &&
                    ...
                    if(!this._authenticated) {
                        let logLine = " Api.js || " + "_authenticate || " + " Successfully Authenticated ";
                        this.homey.app.writeLog(logLine);
                    }
