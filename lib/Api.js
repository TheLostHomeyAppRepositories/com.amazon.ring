...
class Api extends Homey.SimpleClass {
    ...
    */
    ...
    //async grabVideo(device_data, callback) {
    async grabVideo(device_data,offerSdp) {
        ...
        try {
            ...
            //this.log(camera)
            //this.log('External Connection:',camera.initialData.external_connection)
            //this.log('Battery_percentage_category:',camera.initialData.health.battery_percentage_category) //unknown
            // alerts: { connection: 'offline' },
            //if (!camera.initialData.external_connection) throw new Error('Live view not available, camera is operating on battery');
