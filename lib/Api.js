    ...
    async _connectRingAPI() {
        ...
        try {
            ...
            this.locations.forEach(async location => {
                ...
                //this.log('getAlarmMode', await location.getAlarmMode());                
    ...
    _refreshAlarmMode (locationId) {
        ...
        this.locations.forEach(async (location) => {
            if (location.locationDetails.location_id == locationId) {
                this.log('location found',location.locationDetails.name)
                this.log('getAlarmMode',location.getAlarmMode());
                ...
                this.log('locationInfo', locationInfo);
                this.emit('ringOnLocation', locationInfo);
            }
        });
