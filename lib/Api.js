...
const alarmDeviceList = [ 'sensor.contact', 'sensor.motion' ];
...
class Api extends Homey.SimpleClass {
    ...
    async _connectRingAPI() {
        ...
        this.log('_connectRingAPI:           ring-client-api connected:', this.ringApi.restClient.baseSessionMetadata);
            ...
            this.locations.forEach(async location => {
                ...
                if (location.hasAlarmBaseStation) {
                    ...
                    location.onMessage.subscribe((notification) => { 
                        this.log('onMessage',notification)
                    })
        ...
        /*
        this.log('Chime information:',this.chimes)
        this.chimes[0].onData.subscribe((data) => { 
            this.log('chime.onData:',data)
        })
        */
